...
/* Utility functions for uthreads. These are used in the implementation of
mutexes and condition variables; users of the uthread library will not
normally need to use these functions. */
