...
public class CPU extends AbstractSM213CPU {
   ...
   * Fetch instruction at address stored in "pc" register from memory into
   * instruction register
   * and set "pc" to point to the next instruction to execute.
   *
   * Input register: pc.
   * Output registers: pc, instruction, insOpCode, insOp0, insOp1, insOp2,
   * insOpImm, insOpExt
   * 
