...
////////////
/// test harness (run with no args for default values; you code must work for
/// arbitrary)
///

int main(int ac, char** av) {
  /* dynamic allocation and default values for variables and objects found in
   * q1.s */
  ...
  if (ac == 18) {
    ...
    a->b.y[2] = atoi(av[8]);
    a->b.y[3] = atoi(av[9]);
    a->b.a->x[0] = atoi(av[10]);
    a->b.a->x[1] = atoi(av[11]);
    a->b.a->x[2] = atoi(av[12]);
    a->b.a->x[3] = atoi(av[13]);
    a->b.a->b.y[0] = atoi(av[14]);
    a->b.a->b.y[1] = atoi(av[15]);
    a->b.a->b.y[2] = atoi(av[16]);
    a->b.a->b.y[3] = atoi(av[17]);
  }
